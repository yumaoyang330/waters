...
export default class Devicedisplay extends Component {
    ...
    render() {
        return (
            <div id="mobilebody">
                <div className="head">
                    <div className="text"> 上城区中小学直饮水管理系统</div>
                    <div className="nav">
                        <div className="navbar" style={{ width: '30%' }}>
                            <div style={{ height: '.25rem' }}>
                                <img src={require('./nav1.png')} alt=""
                                    style={{ width: '15%' }} />
                            </div>
                            <span>
                                设备信息
                        ...
                        <div className="navbar" style={{ width: '35%' }}>
                            <div style={{ height: '.25rem' }}>
                                <img src={require('./nav2.png')} alt=""
                                    style={{ width: '15%' }} />
                            </div>
                            滤芯更换状况
                        </div>
                        <div className="navbar" style={{ border: 'none', width: '35%' }}>
                            <div style={{ height: '.25rem' }}>
                                <img src={require('./nav3.png')} alt=""
                                    style={{ width: '15%' }} />
                            </div>
                            饮用水检测信息
                        </div>
                ...
                <div className="content">
                    <div className="contenthead">
                        <img src={require('./border.png')} alt="" style={{ width: '1.5%', marginRight: '.2rem' }} />
                        设备信息
                    </div>
                    <div className="list">
                ...
                <div className="content" style={{ marginTop: '.1rem' }}>
                    ...
                    <div className="list">
                        ...
                        <li>目前滤芯已处理净水量（吨）：<span
                            style={{ float: "right", color: this.state.color, fontWeight: this.state.weight, fontSize: this.state.size }}>
                            {this.state.instantFlow}</span>
                        </li>
                    </div>
                </div>
                <div className="dash"></div>
